...
* **Flujo de Acción:**
  1. Llama a `ZohoSprints_GetLogHours` utilizando `teamId` y `projectId`, con `listviewtype=0` (por fecha), y rango de fechas.
  2. Filtra la respuesta por usuario o rango si se requiere.
